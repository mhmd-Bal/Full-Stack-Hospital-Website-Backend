...
$query = $mysqli->prepare("select hospital_users.id, hospital_users.user_id, users.user_name, hospital_users.hospital_id, hospitals.hospital_name, hospital_users.date_joined, hospital_users.date_left
from hospital_users 
